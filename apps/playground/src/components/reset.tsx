...
import { ToggleButton, createIcon } from '@music163/tango-ui';
...
const ResetOutlined = createIcon(ResetSvg, 'ResetOutlined');
...
export const Reset = () => {
  ...
  return (
    <ToggleButton onClick={reset} shape="ghost" tooltip="重置为默认代码">
      <ResetOutlined />
    </ToggleButton>
  );
};
