...
const tangoConfigJson = {
  ...
  packages: {
    ...
    '@music163/tango-mail': {
      ...
      library: 'TangoMail',
      type: 'baseDependency',
      resources: ['https://fastly.jsdelivr.net/npm/@music163/tango-mail@{{version}}/dist/index.js'],
      designerResources: ['https://fastly.jsdelivr.net/npm/@music163/tango-mail@{{version}}/dist/designer.js'],
    },
  },
};
