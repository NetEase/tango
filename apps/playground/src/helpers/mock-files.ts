...
const tangoConfigJson = {
  ...
  packages: {
    react: {
      ...
      library: 'React',
      type: 'dependency',
      resources: ['https://fastly.jsdelivr.net/npm/react@{{version}}/umd/react.development.js'],
    },
    'react-dom': {
      version: '17.0.2',
      library: 'ReactDOM',
      type: 'dependency',
      resources: ['https://fastly.jsdelivr.net/npm/react-dom@{{version}}/umd/react-dom.development.js'],
    },
    'react-is': {
      version: '16.13.1',
      library: 'ReactIs',
      type: 'dependency',
      resources: ['https://fastly.jsdelivr.net/npm/react-is@{{version}}/umd/react-is.production.min.js'],
    },
    'styled-components': {
      version: '5.3.5',
      library: 'styled',
      type: 'dependency',
      resources: ['https://fastly.jsdelivr.net/npm/styled-components@{{version}}/dist/styled-components.min.js'],
    },
    moment: {
      version: '2.29.4',
      library: 'moment',
      type: 'dependency',
      resources: ['https://fastly.jsdelivr.net/npm/moment@{{version}}/moment.js'],
    },
    '@music163/tango-boot': {
      ...
      library: 'TangoBoot',
      type: 'baseDependency',
      resources: ['https://fastly.jsdelivr.net/npm/@music163/tango-boot@{{version}}/dist/boot.js'],
    ...
    '@music163/antd': {
      ...
      type: 'baseDependency',
      resources: [
        'https://fastly.jsdelivr.net/npm/@music163/antd@{{version}}/dist/index.js',
        // 'http://localhost:9002/designer.js',
        'https://fastly.jsdelivr.net/npm/antd@4.24.13/dist/antd.css',
      ],
      designerResources: [
        'https://fastly.jsdelivr.net/npm/@music163/antd@{{version}}/dist/designer.js',
        'https://fastly.jsdelivr.net/npm/antd@4.24.13/dist/antd.css',
      ],
    },
  },
